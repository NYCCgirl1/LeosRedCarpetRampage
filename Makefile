...
SOURCES            = main.c myLib.c game.c hollywood.c redcarpet.c spritesheet.c instructions.c winScreen.c loseScreen.c pauseScreen.c startScreen.c bonuswin1.c bonus.c bonuswin2.c bonuslose.c level2.c level3.c soundLib.c gameSong.c startSong.c winSong.c loseSong.c jump.c gasp.c instructionsSong.c steveBG.c qualudeBG.c qualude.c
